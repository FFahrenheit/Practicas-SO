...
public class ThreadWork extends Thread {
    ...
    public ThreadWork(BCP bcp, JProgressBar progressGraphic, IScheduler scheduler, JTextArea logger){
        this.bcp = bcp;
    ...
    private void updateBar(int i){
        ...
        String text = "(%s) Proceso %d: %d / %d (%d)";
        this.progressGraphic.setString(String.format(text, this.bcp.scheduler, this.bcp.processNumber, this.bcp.runTime, this.bcp.totalTime, this.bcp.runTime));
