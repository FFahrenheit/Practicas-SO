    ...
    public synchronized void run() {
        ...
        while (jobsQueue.size() > 0) {
            if(newProcess){
                ...
                Utils.log("SRT: Buscando nuevo proceso...", logger);
                ...
                if(oldRunner != nextRunner){
                    Utils.log("SRT: Proceso " + nextRunner.bcp.processNumber + " seleccionado" , logger);
                }else{
                    Utils.log("SRT: Se sigue ejecutando el proceso "+ nextRunner.bcp.processNumber, logger);
                }
            }
